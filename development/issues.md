...
1. By opening the issue for discussion: If you believe that you have found
   a new bug in TSCAU, you should report it by creating a new issue in
   the [`tscau/*` issue tracker](https://github.com/tscau/issues).
...
3. By helping to resolve the issue: This can be done by demonstrating
   ...
   a pull request that changes the source in `tscau/*` in a
...
When opening a new issue in the [`tscau/*` issue tracker](https://github.com/tscau/issues/new/choose), users
will be presented with a template that should be filled in.

If you believe that you have found a bug in TSCAU, please fill out the template
